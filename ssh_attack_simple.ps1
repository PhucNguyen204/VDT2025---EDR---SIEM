...
for ($i = 1; $i -le $Count; $i++) {
    ...
    $processEvent = @{
        ...
        "process" = @{
            ...
            "command_line" = "hydra.exe -l $username -P C:\wordlists\pass.txt -t 4 ssh://192.168.1.100" # Sửa đổi command line cho thực tế hơn
            "name" = "hydra.exe"
...
Write-Host "`nDashboard: http://localhost:9090/dashboard" -ForegroundColor Cyan
